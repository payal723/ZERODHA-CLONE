  ...
  return (
    <div className='p-5 mx-auto max-w-7xl'> 
      <div className='flex flex-col items-center text-center'>
        ...
        <Link 
          to="/signup" 
          className='mb-10 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 px-4 rounded-lg shadow-md w-40 transition duration-300 ease-in-out text-center no-underline'>
          Signup For Free
        </Link>
